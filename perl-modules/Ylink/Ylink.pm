...
# Global Variables
##
#$MYSQL_USERNAME_R   = "linkr";
#$MYSQL_USERNAME_RW  = "link";
#$MYSQL_PASSWORD_R   = "xxxxxxx";
#$MYSQL_PASSWORD_RW  = "xxxxxxx";
#$MYSQL_HOST         = "DBI:mysql:ylink:localhost";

$MYSQL_USERNAME_R   = "ylinkruser";
$MYSQL_USERNAME_RW  = "ylinkuser";
$MYSQL_PASSWORD_R   = "xxxxxxxx";
$MYSQL_PASSWORD_RW  = "xxxxxxxx";
$MYSQL_HOST         = "DBI:mysql:ylink:localhost";


$HOSTNAME = 'jump.library.northwestern.edu';
$SECUREURL = 'https://rosebud.library.northwestern.edu/auth/jump/';
...
sub printPage
{
	...
	my $jqurl = 'j-s/jquery-1.5.1.min.js';
	my $jqvurl = 'j-s/jquery.validate.min.js';
	my $jlinkurl = 'j-s/linkvalidate.js';
		...
		print header('-expires' => 'Mon, 26 Jul 1997 05:00:00 GMT',
	             ...
	             start_html( '-onload' => 'setFocus()',
	                    ...
	                    div({-id=>'titleimage'},
	                    	a({-href=>'/', -id=>'factlink'},
	                       img({-src=>'c-s-s/logo.jpg',
	                    	      -label=>'NU Link Shortener',
	                    	      -height=>'26',
	                    	      -width=>'264'}))),
	                    $text,
	                   div({-class=>'footer'}, 'Brought to you by Northwestern University Library' . br() .
	                                           'library *AT* northwestern *DOT* edu') .
	     	       end_html;
...
sub checkAndSetParams
{
	...
	$shortname = uri_unescape($shortname);
	...
	elsif ($url =~ m/^[\s\t]*?http:\/\/www\.yourhost\.edu.*?$/ or $url =~ m/^[\s\t]*?http:\/\/yourhost\.edu.*?$/) {
		$iret = 1;
		$mess = 'You can\'t create a shortened link to this site.';
	}
